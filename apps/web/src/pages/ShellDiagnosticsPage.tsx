...
/** Dev-only: former home diagnostics (GraphQL / AppError demos). */
export function ShellDiagnosticsPage() {
  ...
  return (
    <YStack gap="$3" data-testid="shell-diagnostics-page">
      <Paragraph margin={0} size="$3" color="$color11">
        Dev-only: load data from the API or trigger error paths used by the app shell.
      </Paragraph>
